class HomeworksController < ApplicationController
  ...
  def create
    ...
    params[:homework][:files].each do |file|   
    ...
    respond_to do |format|
      if @homework.save
        format.html { redirect_to user_tests_path, notice: 'Homework was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @homework.update(homework_params)
        format.html { redirect_to user_tests_path, notice: 'Homework was successfully updated.' }
